...
// chakara UI  (npm i @chakra-ui/react-types และ npm i font-awesome
import {
  IconButton,
  Avatar,
  Box,
...
const LinkItems: Array<LinkItemProps> = [
  { name: 'Main', icon: FiHome, href: '/dashboard'},
];
  ...
  return (
    <Box minH="100vh" bg={useColorModeValue('gray.100', 'gray.900')}>
      ...
      <Box ml={{ base: 0, md: 60 }} p="4">
        <Outlet/> {/* สำหรับ content ที่ dynamic ต่อไป */} 
      </Box>
    </Box>
  );
}
        ...
        <Flex alignItems={'center'}>
          <Menu>
            <MenuButton
              ...
              <HStack>
                ...
                <VStack
                  ...
                  spacing="1px"
                  ml="2">
                  <Text fontSize="sm">{userInfo.profile } </Text>
                  <Text fontSize="xs" color="gray.600">
                    {userInfo.profile === 'admin'? 'Admin' : 'User'}
                  </Text>
                </VStack>
            ...
            <MenuList
              ...
              {
                userInfo.profile === 'admin' && <MenuItem>สำหรับผู้ดูแลระบบเท่านั้น</MenuItem>
              }
              <MenuDivider />

              <MenuItem >
                  <button onClick={()=>{ GetOut(); navigation('/');}}> Log Out </button>
              </MenuItem>
            </MenuList>
          </Menu>
        </Flex>
